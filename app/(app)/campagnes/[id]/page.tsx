      ...
      <div className={`px-4 -mt-2 space-y-4 ${isAssigned || isPending || isSubmited ? 'pb-28' : 'pb-8'}`}>
        ...
        {t?.files && (
          <div className="bg-white rounded-2xl shadow-sm p-4">
            ...
            <div className="bg-gray-100 rounded-xl h-40 flex items-center justify-center mb-3 overflow-hidden">
              {t.media_type === "image" || t.files.match(/\.(jpg|jpeg|png|gif|webp)$/i) ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={t.files} alt="Media" className="w-full h-full object-cover rounded-xl" />
              ) : (
